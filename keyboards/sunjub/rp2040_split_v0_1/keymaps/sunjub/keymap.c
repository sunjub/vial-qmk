...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_H,    KC_T,    KC_G,    KC_3,      KC_3,   KC_Y,    KC_N,    KC_E,    KC_O,    KC_I,    KC_BSPC,
    ...
    [_F1] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(1),   MO(3),     KC_TRNS, KC_BSPC, KC_TRNS, KC_HOME, KC_PGDN, KC_PGUP, KC_END
    ),
    [_NUM] = LAYOUT(
    ...
    [_F4] = LAYOUT(
        ...
        KC_LCTL, KC_F4,   KC_F5,   KC_LGUI, KC_F14,  KC_TRNS, KC_V,      KC_ENT,  KC_M,    KC_F13,  KC_DOWN, KC_UP,   KC_RGHT, KC_RGUI
